    ...
    <script>
        $(function(){
            ...
            $("#recycle").bind('click',function(){
                window.location.href="/index.php/Admin/Article/recycle";
            })
...
<div class="admin">
    ...
    <div class="tab">
        <div class="tab-head"> <strong>分类设置</strong>
            <ul class="tab-nav">
                <li ><a href="<?php echo U('Admin/Article/add');?>">添加文章</a></li>
                <li class="active"><a href="javascript:">文章显示</a></li>
            </ul>
        </div>
        <div class="tab-body">
    </div>
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            ...
            <input type="button" class="button button-small border-blue"   value="回收站" id="recycle"/>
        </div>
