  ...
  <div class="tab">
    ...
    <!--添加内容部分-->
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="/index.php/Admin/Article/add" enctype="multipart/form-data">
          <!--1.文章标题-->
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="sitename" name="title" size="50" placeholder="标题名称" data-validate="required:请填写你的文章标题" />
            </div>
          </div>
           ...
           <div class="form-group">
            ...
            <div class="field">
              <select name="pid">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- disabled 表单不能选中 -->
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="sitename" name="keyword" size="50" placeholder="关键词" data-validate="required:请填写你的文章关键词" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="radio" name="isrecommend" value="0" checked="checked">不推荐
              <input type="radio" naem="isrecommend" value="1">推荐
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="sitename" name="author" size="50" placeholder="文章作者" data-validate="required:请填写你的文章作者" />
            </div>
          </div>
          <br/><br/>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <a class="button input-file" href="javascript:void(0);" >+ 浏览文件<input size="100" type="file" name="images"  onchange="previewImage(this)" data-validate="required:请选择上传文件,regexp#.+.(jpg|jpeg|png|gif)$:只能上传jpg|gif|png格式文件" id="upload_img"/></a>
            </div>
          </div>
          <br/><br/><br/>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="sitename" name="introduce" size="50" placeholder="文章介绍" data-validate="required:请填写你的文章介绍" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="siteurl" name="orders" size="50" placeholder="请填写排序" data-validate="required:请填写排序" />
            </div>
          </div>
