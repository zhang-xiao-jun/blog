...
<div class="mainer">
    <div class="admin-navbar">
        ...
        <ul class="nav nav-inline admin-nav">
            ...
            <li><a href="<?php echo U('Admin/Cate/add');?>" class="icon-cog"> 分类管理</a>
                <ul>
                    <li><a href="#">添加分类</a></li>
  ...
  <div class="tab">
    ...
    <!--添加内容部分-->
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="<?php echo U('Admin/Cate/editok');?>">
          <!--分类名称-->
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="sitename" name="cate_name" size="50" placeholder="分类名称" data-validate="required:请填写你的分类名称" value="<?php echo ($data["cate_name"]); ?>"/>
            </div>
          </div>
           ...
           <div class="form-group">
            ...
            <div class="field">
              <select name="cate_pid">
                ...
                <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>"
                    <?php if($data['cate_pid'] == $vo['cate_id']): ?>selected=selected<?php endif; ?>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea class="input" rows="5" cols="50" placeholder="请填写分类说明" data-validate="required:请填写分类说明" name="cate_remark"><?php echo ($data["cate_remark"]); ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="siteurl" name="cate_order" size="50" placeholder="请填写排序" data-validate="required:请填写排序" value="<?php echo ($data["cate_order"]); ?>"/>
            </div>
          </div>
