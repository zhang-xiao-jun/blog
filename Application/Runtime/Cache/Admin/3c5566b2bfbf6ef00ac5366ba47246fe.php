...
<head>
    ...
    <script>
        $(function(){
            $("#passcode").bind('click',function(){
                $('#passcode').attr('src','/index.php/Admin/Public/passcode/-/'+new Date().getTime());
            })
        })
    </script>
</head>
                ...
                <div class="panel-body" style="padding:30px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                            ...
                            <!--验证码-->
                            <img src="/index.php/Admin/Public/passcode" width="80" height="32" class="passcode" id="passcode"/>
                        </div>
                    </div>
                </div>
